            ...
            {currentView === "treasury" && (
              <div className="space-y-6 mt-8 text-center">
                <div className="flex flex-col items-center gap-4 border-b border-current pb-6">
                  <div className="w-24 h-24 bg-yellow-600 rounded-full flex items-center justify-center border-4 border-yellow-400 shadow-[0_0_30px_rgba(234,179,8,0.5)] animate-pulse">
                ...
                >
                  <div className="mb-6">
                    <label className="block text-sm font-bold mb-2 opacity-80 uppercase tracking-wider">
                      Donation Amount (ETH)
                    </label>
                    <div className="flex items-center gap-2">
                      ...
                      <input
                        ...
                        className={`w-full p-3 rounded text-xl font-mono text-center outline-none focus:ring-2 focus:ring-yellow-500 ${
                          isNight
                  ...
                  <button
                    ...
                    disabled={isDonating}
                    className={`w-full py-4 px-6 rounded-lg font-bold text-lg transition-all transform hover:scale-105 flex items-center justify-center gap-3 ${
                      isDonating
